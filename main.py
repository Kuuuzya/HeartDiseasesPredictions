...
smoke = lc.radio("Курите?", options=("Нет", "Да"), key='smoke', horizontal=st.session_state.horizontal)
alco = lc.radio("Пьёте?", options=("Нет", "Да"), key='alco', horizontal=st.session_state.horizontal)
